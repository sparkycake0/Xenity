...
export default function Navbar() {
  ...
  return (
    <nav className="w-screen h-max bg-neutral-800 p-2">
      ...
      >
        ...
        <div className="flex flex-col items-start justify-center w-max gap-10">
          <div
          ...
          <div
            className="flex w-full hover:bg-violet-700 transition-colors duration-200 rounded-lg p-2 font-bold gap-2 justify-center items-center cursor-pointer"
            onClick={() => {
              router.push("/");
            }}
          >
          ...
          <div
            className="flex hover:bg-violet-700 transition-colors duration-200 rounded-lg p-2 font-bold gap-2 justify-center items-center cursor-pointer"
            onClick={() => {
              router.push("/account");
            }}
          >
          ...
          <div className="absolute bottom-0 left-0 flex w-full p-4 font-bold justify-center items-center">
            <div
              className="flex hover:bg-violet-700 transition-colors duration-200 rounded-lg bottom-0 w-full left-0 p-2 font-bold gap-2 justify-center items-center cursor-pointer"
              onClick={() => {
                router.push("/about");
              }}
            >
